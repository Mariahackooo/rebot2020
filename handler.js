...
global.dfail = (type, m, conn) => {
  let msg = {
    ...
    premium: 'Este comando só para membro _*Premium*_ !',
    group: 'Este comando só pode ser usado em grupo',
    private: 'Este comando só pode ser usado em chats privados!',
    admin: 'Este comando é apenas para * Admin *! ',
    botAdmin: 'Torne o bot um * Admin * para usar este comando! ',
    unreg: 'Registre-se para usar esta função digitando:\n\n*#reg nome.edad*\n\nExemplo: *#reg pimpim.17*'
  }[type]
